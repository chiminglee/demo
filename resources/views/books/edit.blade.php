                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('books.update', $book->id) }}">
                        ...
                        <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="description" type="text" class="form-control" name="description" value="{{ $book->description }}" required>
                        ...
                        <div class="form-group{{ $errors->has('published_at') ? ' has-error' : '' }}">
                            <label for="published_at" class="col-md-4 control-label">Published Date</label>

                            <div class="col-md-6">
                                <input id="published_at" type="date" class="form-control" name="published_at" value="{{ $book->published_at }}" required>
